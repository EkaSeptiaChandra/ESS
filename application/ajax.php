...
class PilhCaleg {
    ...
    function getRecords($req, $col, $idprov, $iddapil) {
        ...
        $sqltot .= ") as temp group by kode_caleg, nama_caleg, nama_partai, nama_provinsi, nama_dapil";
        ...
        if (!empty($req['search']['value'])) {
            ...
            // $sql .= " WHERE kode_kabupaten_kota LIKE '%" . $req['search']['value'] . "%' ";
            // $sql .= " OR nama_kabupaten_kota LIKE '%".$req['search']['value']."%'";
            // $sql .= " OR nama_provinsi LIKE '%".$req['search']['value']."%'";
